...
public class StepDefinition extends BaseClass2 {
	...
	public void user_navigate_to_error() throws IOException {
	...
	public void user_to_click_on_proceed() throws InterruptedException, IOException {
		// String url = FileReaderManager.getInstance().getCrInstance().getUrl();
		// driver.get(url);
	...
	public void user_enter_valid_username_in_the_username_field(String username) {
	...
	public void user_confirm_that_it_navigates_to_the_homepage() {

	}

	@Given("^User to navigate the booking detailed page$")
	public void user_to_navigate_the_booking_detailed_page() {

	}
	@When("^User select an location option in the location field$")
	public void user_select_an_location_option_in_the_location_field() {
	...
	public void user_select_an_hotel_option_in_the_hotel_field() {
	...
	public void user_select_an_hoteltype_option_in_the_hoteltype_field() {
	...
	@When("^User select an rooms option in the rooms field$")
	public void user_select_an_rooms_option_in_the_rooms_field(String value) {
		typehere(pom.getAdp2().getRooms(), value);
		// Adpage2 ap2 = new Adpage2(driver);
	...
	public void user_to_navigate_the_selection_page() {

	}

	@When("^User click an selectbutton option in the selectbutton field$")
	public void user_click_an_selectbutton_option_in_the_selectbutton_field() {
	...
	public void user_click_an_continue_option_in_the_continue_field() {	
	...
	public void user_to_navigate_the_confirmation_page() {
	...
	public void user_enter_valid_creditcard_in_the_creditcard_field() {
	...
	public void user_enter_valid_expmonth_in_the_expmonth_field(String value)  {
	...
	public void user_enter_valid_expyear_in_the_expyear_field(String value) {
	...
	public void user_click_an_booknow_in_the_booknow_field() {
	...
	public void user_confirm_that_it_navigate_to_logoutpage() {
